...
// Determine which header file to include based on the page being accessed
$header_file = 'header.php';
if (isset($_SESSION['Admins-name']) == 'admins.php') {
...
<body>
<?php include $header_file; // Include the determined header file ?>
<main>
